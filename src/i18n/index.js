...
export const translations = {
  ...
  'en-US': {
    ...
    outboundNames: {
      ...
      'TikTok': '🎵 TikTok',
      'Bahamut': '🇹🇼 Bahamut',
      'Game Direct': '🎮 China Games',
      'Microsoft CN': 'Ⓜ️ Microsoft China',
      'Apple CN': '🍏 Apple China',
  ...
  'fa': {
    ...
    outboundNames: {
      ...
      'BiliIntl': '🌏 بیلی‌بیلی بین‌المللی',
      'TikTok': '🎵 TikTok',
      'Bahamut': '🇹🇼 باهاموت',
      'Game Direct': '🎮 بازی‌های چین',
      'Microsoft CN': 'Ⓜ️ مایکروسافت چین',
      'Apple CN': '🍏 اپل چین',
  ...
  'ru': {
    ...
    outboundNames: {
      ...
      'BiliIntl': '🌏 Bilibili International',
      'TikTok': '🎵 TikTok',
      'Bahamut': '🇹🇼 Bahamut',
      'Game Direct': '🎮 Игры Китая',
      'Microsoft CN': 'Ⓜ️ Microsoft в Китае',
      'Apple CN': '🍏 Apple в Китае',
